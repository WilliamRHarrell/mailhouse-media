            ...
            {[
              {
                ...
                a: "EDDM delivers to every home on a carrier route (no filtering). Targeted lists use the same USPS data but filter down to specific demographics — so you pay more per home ($0.11 vs $0.06), but you only mail to addresses that match your criteria. EDDM is better for broad awareness, targeted lists are better for precision.",
              },
              {
